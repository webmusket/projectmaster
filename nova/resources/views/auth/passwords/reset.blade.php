...
@section('content')
    ...
    >
        ...
        <div class="mb-6 {{ $errors->has('email') ? ' has-error' : '' }}">
            ...
            <input class="form-control form-input form-input-bordered w-full" id="email" type="email" name="email"
        ...
        <div class="mb-6 {{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
            ...
            <input class="form-control form-input form-input-bordered w-full" id="password-confirm" type="password"
